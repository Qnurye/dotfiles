...
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "install"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "bundle"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "uninstall"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "migrate"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "list"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "info"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "gc"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "reset"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "init"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "completion"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "run"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "update"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "outdated"
complete -c zb -n "__fish_zb_using_subcommand help; and not __fish_seen_subcommand_from install bundle uninstall migrate list info gc reset init completion run update outdated help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
